...
void main()
{
    ...
    switch (uint(in_var_COLOR1.x + 0.5))
    {
        ...
        case 1u:
        {
            _1722 = texture(SPIRV_Cross_CombinedTexture0Sampler0, in_var_TEXCOORD0) * in_var_COLOR0;
            break;
        }
        case 2u:
        {
            ...
            do
            {
                vec2 _1676 = Uniforms.Vector[1].zw + Uniforms.Vector[1].xy;
                vec2 _1692 = fract((((Uniforms.Vector[2].xy * in_var_TEXCOORD1.x) + (Uniforms.Vector[2].zw * in_var_TEXCOORD1.y)) + Uniforms.Vector[3].xy) / _1676) * _1676;
                bool _1702;
                ...
                _1716 = texture(SPIRV_Cross_CombinedTexture0Sampler0, ((_1692 / Uniforms.Vector[1].zw) * (Uniforms.Vector[0].zw - Uniforms.Vector[0].xy)) + Uniforms.Vector[0].xy) * in_var_COLOR0;
                break;
            } while(false);
            _1722 = _1716;
            break;
        ...
        case 7u:
        {
            ...
            do
            {
                ...
                bvec2 _2415 = isnan(_1422);
                bvec2 _2416 = isnan(vec2(0.0));
                vec2 _2417 = max(_1422, vec2(0.0));
                vec2 _2418 = vec2(_2415.x ? vec2(0.0).x : _2417.x, _2415.y ? vec2(0.0).y : _2417.y);
                _1430 = (isnan(0.0) ? _1425 : (isnan(_1425) ? 0.0 : min(_1425, 0.0))) + length(vec2(_2416.x ? _1422.x : _2418.x, _2416.y ? _1422.y : _2418.y));
                break;
            } while(false);
            float _1431 = -_1430;
            ...
            do
            {
                ...
                switch (uint(in_var_COLOR1.y + 0.5))
                {
                    ...
                    case 11u:
                    {
                        vec3 _762 = _194.xyz;
                        vec3 _763 = _198.xyz;
                        bvec3 _2425 = isnan(_762);
                        bvec3 _2426 = isnan(_763);
                        vec3 _2427 = min(_762, _763);
                        vec3 _2428 = vec3(_2425.x ? _763.x : _2427.x, _2425.y ? _763.y : _2427.y, _2425.z ? _763.z : _2427.z);
                        float _765 = _194.w;
                        _811 = vec4(vec3(_2426.x ? _762.x : _2428.x, _2426.y ? _762.y : _2428.y, _2426.z ? _762.z : _2428.z) * _765, _198.w * _765);
                        _812 = true;
                        break;
                    }
                    case 12u:
                    ...
                    case 17u:
                    {
                        vec3 _673 = _194.xyz;
                        vec3 _674 = _198.xyz;
                        bvec3 _2430 = isnan(_673);
                        bvec3 _2431 = isnan(_674);
                        vec3 _2432 = max(_673, _674);
                        vec3 _2433 = vec3(_2430.x ? _674.x : _2432.x, _2430.y ? _674.y : _2432.y, _2430.z ? _674.z : _2432.z);
                        float _676 = _194.w;
                        _811 = vec4(vec3(_2431.x ? _673.x : _2433.x, _2431.y ? _673.y : _2433.y, _2431.z ? _673.z : _2433.z) * _676, _198.w * _676);
                        _812 = true;
                        break;
                    }
                    case 18u:
        ...
        case 10u:
        {
            ...
            float _179 = _178.w;
            _1722 = vec4(_174.xyz * _179, _174.w * _179);
            break;
        }
        case 11u:
        {
    ...
    {
        vec4 _1741 = vec4(spvWorkaroundRowMajor(Uniforms.Clip[_1727])[0].x, spvWorkaroundRowMajor(Uniforms.Clip[_1727])[1].x, spvWorkaroundRowMajor(Uniforms.Clip[_1727])[2].x, spvWorkaroundRowMajor(Uniforms.Clip[_1727])[3].x);
        vec4 _1748 = vec4(spvWorkaroundRowMajor(Uniforms.Clip[_1727])[0].y, spvWorkaroundRowMajor(Uniforms.Clip[_1727])[1].y, spvWorkaroundRowMajor(Uniforms.Clip[_1727])[2].y, spvWorkaroundRowMajor(Uniforms.Clip[_1727])[3].y);
        vec4 _1750 = floor(_1748 * vec4(1.52587890625e-05));
        vec4 _1753 = floor(_1748 - (_1750 * 65536.0));
        vec4 _1763 = vec4(spvWorkaroundRowMajor(Uniforms.Clip[_1727])[0].z, spvWorkaroundRowMajor(Uniforms.Clip[_1727])[1].z, spvWorkaroundRowMajor(Uniforms.Clip[_1727])[2].z, spvWorkaroundRowMajor(Uniforms.Clip[_1727])[3].z);
        vec2 _1773 = (((_1763.xy * in_var_TEXCOORD1.x) + (_1763.zw * in_var_TEXCOORD1.y)) + vec4(spvWorkaroundRowMajor(Uniforms.Clip[_1727])[0].w, spvWorkaroundRowMajor(Uniforms.Clip[_1727])[1].w, spvWorkaroundRowMajor(Uniforms.Clip[_1727])[2].w, _110).xy) - _1741.xy;
        float _2386;
        do
        {
            vec2 _1776 = _1741.zw * 0.5;
            float _1777 = _1776.x;
            float _1778 = -_1777;
            float _1779 = _1750.x;
            ...
            vec2 _1786 = _1773 - vec2(_1780, _1784);
            bool _1793;
            if ((_1779 * _1783) > 0.0)
            {
                _1793 = _1773.x < _1780;
            ...
            if (_1798)
            {
                ...
                do
                {
                    ...
                    else
                    {
                        ...
                        float _1859 = float(int(sign(_1853))) * pow(abs(_1853), 0.3333333432674407958984375);
                        float _1860 = _1841 - _1852;
                        float _1866 = float(int(sign(_1860))) * pow(abs(_1860), 0.3333333432674407958984375);
                    ...
                    _1929 = length(vec2(_1820.x * _1915, _1920) - _1819) * float(int(sign(_1819.y - _1920)));
                    break;
                } while(false);
                _2386 = _1929;
                break;
            ...
            vec2 _1935 = _1773 - vec2(_1931, _1933);
            bool _1942;
            if ((_1930 * _1932) > 0.0)
            {
                _1942 = _1773.x >= _1931;
            ...
            if (_1947)
            {
                ...
                do
                {
                    ...
                    else
                    {
                        ...
                        float _2008 = float(int(sign(_2002))) * pow(abs(_2002), 0.3333333432674407958984375);
                        float _2009 = _1990 - _2001;
                        float _2015 = float(int(sign(_2009))) * pow(abs(_2009), 0.3333333432674407958984375);
                    ...
                    _2078 = length(vec2(_1969.x * _2064, _2069) - _1968) * float(int(sign(_1968.y - _2069)));
                    break;
                } while(false);
                _2386 = _2078;
                break;
            ...
            vec2 _2084 = _1773 - vec2(_2080, _2082);
            bool _2091;
            if ((_2079 * _2081) > 0.0)
            {
                _2091 = _1773.x >= _2080;
            ...
            if (_2096)
            {
                ...
                do
                {
                    ...
                    else
                    {
                        ...
                        float _2157 = float(int(sign(_2151))) * pow(abs(_2151), 0.3333333432674407958984375);
                        float _2158 = _2139 - _2150;
                        float _2164 = float(int(sign(_2158))) * pow(abs(_2158), 0.3333333432674407958984375);
                    ...
                    _2227 = length(vec2(_2118.x * _2213, _2218) - _2117) * float(int(sign(_2117.y - _2218)));
                    break;
                } while(false);
                _2386 = _2227;
                break;
            ...
            vec2 _2233 = _1773 - vec2(_2229, _2231);
            bool _2240;
            if ((_2228 * _2230) > 0.0)
            {
                _2240 = _1773.x < _2229;
            ...
            if (_2245)
            {
                ...
                do
                {
                    ...
                    else
                    {
                        ...
                        float _2306 = float(int(sign(_2300))) * pow(abs(_2300), 0.3333333432674407958984375);
                        float _2307 = _2288 - _2299;
                        float _2313 = float(int(sign(_2307))) * pow(abs(_2307), 0.3333333432674407958984375);
                    ...
                    _2376 = length(vec2(_2267.x * _2362, _2367) - _2266) * float(int(sign(_2266.y - _2367)));
                    break;
                } while(false);
                _2386 = _2376;
                break;
            }
            vec2 _2378 = abs(_1773) - _1776;
            float _2379 = _2378.x;
            float _2380 = _2378.y;
            float _2381 = isnan(_2380) ? _2379 : (isnan(_2379) ? _2380 : max(_2379, _2380));
            bvec2 _2615 = isnan(_2378);
            bvec2 _2616 = isnan(vec2(0.0));
            vec2 _2617 = max(_2378, vec2(0.0));
            vec2 _2618 = vec2(_2615.x ? vec2(0.0).x : _2617.x, _2615.y ? vec2(0.0).y : _2617.y);
            _2386 = (isnan(0.0) ? _2381 : (isnan(_2381) ? 0.0 : min(_2381, 0.0))) + length(vec2(_2616.x ? _2378.x : _2618.x, _2616.y ? _2378.y : _2618.y));
            break;
        } while(false);
        float _2389 = -(_2386 * ((spvWorkaroundRowMajor(Uniforms.Clip[_1727])[2].w != 0.0) ? (-1.0) : 1.0));
        float _2392 = smoothstep(-0.61804687976837158203125, 0.61804687976837158203125, _2389 / fwidth(_2389));
        _1725 = vec4(_1724.xyz * _2392, _1724.w * _2392);
    }
    out_var_SV_Target = _1724;
}
