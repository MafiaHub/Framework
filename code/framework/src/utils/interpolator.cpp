...
namespace Framework::Utils {
    void Interpolator::Position::SetTargetValue(const glm::vec3 &current, const glm::vec3 &target, float delay) {
    ...
    glm::vec3 Interpolator::Position::UpdateTargetValue(const glm::vec3 &current) {
        if (!HasTargetValue())
            return current;
    ...
    void Interpolator::Rotation::SetTargetValue(const glm::quat &current, const glm::quat &target, float delay) {
        UpdateTargetValue(current);
    ...
    glm::quat Interpolator::Rotation::UpdateTargetValue(const glm::quat &current) {
        if (!HasTargetValue())
            return current;
    ...
    void Interpolator::Scalar::SetTargetValue(const float &current, const float &target, float delay) {
        UpdateTargetValue(current);
    ...
    float Interpolator::Scalar::UpdateTargetValue(const float &current) {
        if (!HasTargetValue())
            return current;
