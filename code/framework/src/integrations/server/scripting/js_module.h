...
namespace Framework::Integrations::Server::Scripting {
    ...
    /**
     * Information about a JS resource for sending to clients.
     */
    struct JSClientResourceInfo {
        std::string name;
        std::string version;
    };
     ...
     */
    class JSServerScriptingModule {
      public:
        explicit JSServerScriptingModule(std::shared_ptr<World::ServerEngine> world);
        ~JSServerScriptingModule();
         ...
         */
        Framework::Scripting::JS::NodeEngine *GetEngine() const {
         ...
         */
        std::vector<JSClientResourceInfo> GetClientResourceList() const;
      ...
      private:
        std::unique_ptr<Framework::Scripting::JS::NodeEngine> _nodeEngine;
