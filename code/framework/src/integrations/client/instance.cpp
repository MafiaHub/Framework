        ...
        if (_opts.useRenderer)
        {
            if (_renderer)
            {
                ...
                case Graphics::RendererBackend::BACKEND_D3D_11:
                    _renderer->GetD3D11Backend()->Init(_opts.rendererOptions.d3d11.device,
                                                       _opts.rendererOptions.d3d11.deviceContext, nullptr, nullptr);
                    break;
    ...
    void Instance::InitNetworkingMessages() {
        ...
        net->SetOnPlayerConnectedCallback([this, net](SLNet::Packet *packet) {
            ...
            msg.FromParameters(_currentState._nickname, "MY_SUPER_ID_1", "MY_SUPER_ID_2", Utils::Version::rel,
                               _opts.gameVersion, _opts.gameName);

            net->Send(msg, SLNet::UNASSIGNED_RAKNET_GUID);
        });
        net->RegisterMessage<ClientConnectionFinalized>(
            GameMessages::GAME_CONNECTION_FINALIZED,
            [this, net](SLNet::RakNetGUID _guid, ClientConnectionFinalized *msg) {
        ...
        net->RegisterMessage<ClientKick>(
            GameMessages::GAME_CONNECTION_KICKED, [](SLNet::RakNetGUID guid, ClientKick *msg) {
                ...
                case Framework::Networking::Messages::DisconnectionReason::BANNED:
                    ...
                    break;
                case Framework::Networking::Messages::DisconnectionReason::KICKED:
                    reason = "You have been kicked.";
                    break;
                case Framework::Networking::Messages::DisconnectionReason::KICKED_INVALID_PACKET:
                    reason = "You have been kicked (invalid packet).";
                    break;
                case Framework::Networking::Messages::DisconnectionReason::WRONG_VERSION:
                    reason = "You have been kicked (wrong client version).";
                    break;
                case Framework::Networking::Messages::DisconnectionReason::INVALID_PASSWORD:
                    reason = "You have been kicked (wrong password).";
                    break;
                default:
                    break;
                }
