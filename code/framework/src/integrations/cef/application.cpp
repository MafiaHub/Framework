...
namespace Framework::Integrations::CEF {
    void Application::OnRegisterCustomSchemes(CefRawPtr<CefSchemeRegistrar> registrar) {
        ...
        registrar->AddCustomScheme("framework", CEF_SCHEME_OPTION_STANDARD | CEF_SCHEME_OPTION_SECURE
                                                    | CEF_SCHEME_OPTION_CORS_ENABLED | CEF_SCHEME_OPTION_FETCH_ENABLED);
    }

    void Application::OnContextInitialized() {}

    void Application::OnContextCreated(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame,
                                       CefRefPtr<CefV8Context> context) {}

    void Application::OnContextReleased(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame,
                                        CefRefPtr<CefV8Context> context) {}

    void Application::OnBeforeCommandLineProcessing(const CefString &processType,
    ...
    bool Application::OnProcessMessageReceived(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame,
                                               CefProcessId sourceProcess, CefRefPtr<CefProcessMessage> message) {
        return true;
    }

    bool Application::Execute(const CefString &name, CefRefPtr<CefV8Value> object, const CefV8ValueList &arguments,
