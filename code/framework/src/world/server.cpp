...
namespace Framework::World {
    EngineError ServerEngine::Init(Framework::Networking::NetworkPeer *networkPeer, float tickInterval) {
        ...
        _isEntityVisible = [](const flecs::entity streamerEntity, const flecs::entity e,
                              const Modules::Base::Transform &lhsTr, const Modules::Base::Streamer &streamer,
                              const Modules::Base::Streamable &lhsS, const Modules::Base::Transform &rhsTr,
        ...
        _world->system<Modules::Base::Transform, Modules::Base::Streamable>("AssignEntityOwnership")
            ...
            .each([this](flecs::entity e, Modules::Base::Transform &tr, Modules::Base::Streamable &streamable) {
                ...
                else
                {
                    ...
                    _findAllStreamerEntities.each([this, &e, &tr, &closestDist, &closestOwnerGUID,
                                                   &streamable](flecs::entity rhsE, Modules::Base::Streamer &rhsS) {
        ...
        _world->system<Modules::Base::Streamer>("CollectRangeExemptEntities")
            .kind(flecs::PostUpdate)
            .interval(tickInterval * 4.0f)
            .each([this](flecs::entity e, Modules::Base::Streamer &streamer) {
        ...
        _world
            ->system<Modules::Base::TickRateRegulator, Modules::Base::Transform, Modules::Base::Streamable>(
                "TickRateRegulator")
            .interval(3.0f)
        ...
        _world->system<Modules::Base::Transform, Modules::Base::Streamer, Modules::Base::Streamable>("StreamEntities")
            ...
            .iter([this](flecs::iter it, Modules::Base::Transform *tr, Modules::Base::Streamer *s,
                ...
                for (size_t i = 0; i < it.count(); i++)
                {
                    ...
                    _allStreamableEntities.each(
                        [&](flecs::entity e, Modules::Base::Transform &otherTr, Modules::Base::Streamable &otherS) {
                            // Skip dead entities.
                            if (!e.is_alive())
                                return;
