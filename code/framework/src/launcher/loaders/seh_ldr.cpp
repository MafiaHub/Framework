	...
	if (baseAddress)
	{
		...
		if (!internalAddress)
		{
			...
			if (!internalAddress)
			{
				...
				{
					printf("could not find RtlpxLookupFunctionTable - hooking RtlLookupFunctionTable directly. This will break on a Win8+ system since RtlpxLookupFunctionTable is supposed to exist!\n");
				}
