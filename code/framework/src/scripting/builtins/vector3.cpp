...
namespace Framework::Scripting::Builtins {
    ...
    v8pp::class_<Vector3> &Vector3::GetClass(v8::Isolate *isolate) {
        ...
        cls       = std::make_unique<v8pp::class_<Vector3>>(isolate, GetScriptingCatalog(isolate), "Vector3", "Mutable three-dimensional vector exposed as the global Vector3 for positions, directions, and Euler angles.");
    ...
    void Vector3::UnregisterIsolate(v8::Isolate *isolate) {
